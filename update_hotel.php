...
<body>
  ...
  <div class="container">
    <h1>Add hotels</h1>
   <form name="destform" action="upload_hotel.php" method="get">

    <label for="rent">Hotel Name</label>
	<input type="text" name="hname" ><br>
	<label for="rent">Hotel Description</label>
	<input type="text" name="hdesc" ><br>
